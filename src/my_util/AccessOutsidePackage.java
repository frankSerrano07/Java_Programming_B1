...
import day33B_Encaptulation_AccessModifierTest.AccessModifiers;
...
public class AccessOutsidePackage {
    public static void main(String[] args) {
        ...
        // System.out.println(obj.y); // since the access modifier for static variable y is default, it is accessible only in the same package.
